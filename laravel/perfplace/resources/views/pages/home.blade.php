...
<form class="well container-fluid" method="get" id="searchForm" action="/results">
	...
	<div class="col-sm-offset-3 col-sm-6">
		...
		<div>
			<input style="width:50%" type="submit" name="buyButton" class="submit btn btn-default transaction-type" value="Buy" onclick="validateSearchTextField()">
			<input style="width:50%" type="submit" name="rentButton" class="submit btn btn-default transaction-type" value="Rent" onclick="validateSearchTextField()">
		</div>
	</div>
</form>
