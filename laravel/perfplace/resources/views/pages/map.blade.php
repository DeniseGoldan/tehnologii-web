        ...
        <div class="row">
            <div class="container-fluid col-sm-3">
                <form class="myWell" method="GET" id="filterForm">
                    ...
                    <fieldset>
                        ...
                        <div class="container">
                            <label class="label-for-checkbox">
                                <input type="checkbox" name="transactionType" id="buyCheck">Buy
                            </label>
                            <label>
                                <input type="checkbox" name="transactionType" id="rentCheck">Rent
                            </label>
                        </div>
                    </fieldset>
                    <fieldset>
                    ...
                    title="Add pins of the filtered houses on the map">
...
@section('scripts')
    ...
    <script type="text/javascript" src="js/homeSearchTriggersTansactionCheck.js"></script>
